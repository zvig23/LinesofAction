...
public class LOAGUI extends JApplet {
  ...
  private LOACustomPanel boardPanel;
  ...
  public void buildGUI() {
    ...
    boardPanel = new LOACustomPanel(this);
    ...
    if (s.equals("White")) {
      ...
      startAsBlack = false;
      boardPanel.user_move = LOACustomPanel.WAIT1;
